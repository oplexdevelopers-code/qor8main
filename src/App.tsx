...
const ALL_PRODUCTS = [
  {
    ...
    description: 'Secure communication, announcements, tasks and collaboration that keeps every conversation organised, connected and protected.',
  ...
  },
  {
    ...
    description: 'Your personal and business control centre. Manage documents, workflows, approvals, reminders and daily operations from one intelligent platform.',
  ...
  },
  {
    ...
    description: 'Simplify your workforce with onboarding, compliance, training, leave, performance and employee management—all in one place.',
  ...
  },
  {
    ...
    description: 'Smarter time and attendance with GPS verification, facial recognition, rotas, scheduling, payroll integration and real-time reporting.',
  ...
  },
  {
    ...
    description: 'Manage properties, tenants, inspections, maintenance, compliance and assets with complete visibility from one dashboard.',
  ...
  },
  {
    ...
    description: 'Report, assign and resolve maintenance issues faster with live tracking, contractor management and complete audit history.',
  ...
  },
  {
    ...
    description: 'Instantly verify identities, credentials and compliance documents with secure digital verification you can trust.',
  ...
  },
  {
    ...
    description: 'AI-powered wellbeing, communication and resilience coaching that helps people think clearly, perform confidently and thrive.',
  ...
  },
  {
    ...
    description: 'Digital care management designed around people. Deliver safer care with real-time records, compliance, medication, incidents and family engagement.',
  ...
  },
  {
    ...
    description: 'Streamline purchasing, suppliers, approvals, invoices and spending with complete control from request to payment.',
      ...
      <header className="app-header">
        <div className="header-content">
          ...
          <div className="header-right">
            ...
            <a href="#help" className="help-button" aria-label="Help">
